...
namespace Silver_J
{
    public partial class MainForm : Form
    {
        ...
        public void SelectJDKPath_OnStartup()
        {
            ...
            {
                DialogResult dg = MessageBox.Show("Hi! Welcome to ThinkJava!\nWe are preparing something to you for your first use.\nWhile you wait, why don't you specify the JDK path?", "Hello there!", MessageBoxButtons.OKCancel);
                if (dg == DialogResult.OK)
                {
                    ...
                    else
                    {
                        ...
                        {
                            DialogResult dg2 = MessageBox.Show("Error while doing setup. Details are here shown.\nERROR 296 occured.\nCode: CONFIG_FILE_INACCESSIBLE", "Error",MessageBoxButtons.OK);
                            if (dg == DialogResult.OK)
                            {
                                Application.Exit();
                                shutdown();
        ...
        public void SetAppearances(String type)
        {
            ...
            else if(type=="Night")
            {
                ...
                mouseHoverLabel1.ForeColor = System.Drawing.Color.White;
                mouseHoverLabel2.ForeColor = System.Drawing.Color.White;
                mouseHoverLabel3.ForeColor = System.Drawing.Color.White;
        ...
        private void menuitem_MouseEnter(object sender, EventArgs e)
        {
            ...
            switch (s)
            {
                ...
                case "New File":
                    ...
                    break;
                case "Open Project":
                    ShowAboutToolStripLabel.Text = "Open another project in ThinkJava";
                    break;
                case "Open Files":
                ...
                case "Print Preview":
                    ...
                    break;
                case "Exit":
                    ShowAboutToolStripLabel.Text = "Exit ThinkJava (warning: jetbrains will win)";
                    break;
                ...
                case "Preview HTML Page":
                    ...
                    break;
                case "Options":
                    ShowAboutToolStripLabel.Text = "Change the options of ThinkJava IDE or appearance";
                    break;
        ...
        private void MainForm_Closing(object sender, FormClosingEventArgs e)
        {
            ...
            if (myTabControl.TabCount > 0)
            {
                ...
                if (this.Text != "ThinkJava" && isfile == true)
                {
                ...
                else if (this.Text == "ThinkJava" && isfile == true)
                {
                    DialogResult dr = MessageBox.Show("Save modified files before exist ?\n\nClick Yes to Save all modified files one by one\nClick No to exit without saving", "Save ?", MessageBoxButtons.YesNoCancel);
...
//***********************************************************************************************************************************
        ...
        private void File_New_JavaApplicationProjectMenuItem_Click(object sender, EventArgs e)
        {
                    ...
                    if (ReadCurrentProjectFileName() != "" && File.Exists(ReadCurrentProjectFileName()))
                    {
                        ...
                        if (File.Exists(projectfilename2))
                        {
                            ...
                            if (projectfilename2 != "")
                            {
                                ...
                                prjname = prjname.Remove(prjname.Length - 9);
                                this.Text = "ThinkJava - " + prjname + " [Java Application without Class]";
            ...
            {
                FilenameToolStripLabel.Text = "ThinkJava";
            ...
            else if (njaf.CheckProjectType() == 1)
            {
                if (ReadCurrentProjectFileName() != "" && File.Exists(ReadCurrentProjectFileName()))
                {
                    ...
                    if (projectfilename2 != "" && htmlfilename != "")
                    {
                        ...
                        String prjname = projectfilename2.Substring(projectfilename2.LastIndexOf("\\") + 1);
                        prjname = prjname.Remove(prjname.Length - 9);
                        this.Text = "ThinkJava - " + prjname + " [Java Applet without Class]";
          ...
          else
            {
                if (OpenProjectFileDialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    if (File.Exists(projectfilename))
                    {
                        ...
                        //add project name to form
                        this.Text = "ThinkJava - " + projectname + " [Opened Project]";
        ...
        public void OpenProject(String projectfilename)
        {
            ...
            if (File.Exists(projectfilename))
            {
                ...
                //add project name to form
                this.Text = "ThinkJava - Currently editing " + projectname;
...
//***********************************************************************************************************************************
 ...
 //***********************************************************************************************************************************
        ...
        private void mouseHoverLabel1_Click(object sender, EventArgs e)
        {
            System.Diagnostics.Process.Start("https://sourceforge.net/projects/thinkjava-ide/reviews");
        }

        private void mouseHoverLabel2_Click(object sender, EventArgs e)
        {
            System.Diagnostics.Process.Start("https://www.paypal.me/ZIsnomo");
        }

        private void startpagepanel_Paint(object sender, PaintEventArgs e)
        {

        }

        private void mouseHoverLabel3_Click(object sender, EventArgs e)
        {
            System.Diagnostics.Process.Start("https://discord.gg/YARVk4qP2H");
        }

        private void toolStripMenuItem1_Click(object sender, EventArgs e)
        {
            StoreForm shop = new StoreForm();
            shop.ShowDialog();
        }
        ...
        private void ShowAboutToolStripLabel_Click(object sender, EventArgs e)
        {
            System.Diagnostics.Process.Start("https://www.youtube.com/watch?v=S0qC_J1VaZI");
        }
        ...
        private void mouseHoverLabel4_Click(object sender, EventArgs e)
        {
            System.Diagnostics.Process.Start("https://www.youtube.com/watch?v=S0qC_J1VaZI");
            MessageBox.Show("APRIL FOOLS DAY!!!!!!");
        }
